...
- [ ] The page body includes a ## Roles section listing work_stakeholder_roles rows: scope_type, scope (name), role, effective_from.
...
`work_stakeholder_roles` is in the section 4 migration added in #039.
